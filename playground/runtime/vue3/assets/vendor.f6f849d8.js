...
function configFromArray(config) {
  ...
  if (config._dayOfYear != null) {
    yearToUse = defaults$5(config._a[YEAR], currentDate[YEAR]);
...
function dayOfYearFromWeekInfo(config) {
  ...
  if (w.GG != null || w.W != null || w.E != null) {
    dow = 1;
    doy = 4;
    weekYear = defaults$5(w.GG, config._a[YEAR], weekOfYear(createLocal(), 1, 4).year);
    ...
    weekYear = defaults$5(w.gg, config._a[YEAR], curWeek.year);
...
export { axios as a, events as e };
//# sourceMappingURL=vendor.f6f849d8.js.map
